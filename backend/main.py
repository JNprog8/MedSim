...
from backend.infrastructure.database.mongo_config import init_db
...
async def startup_db_client():
    await init_db()
    # Ejecutar migraciones de JSON a DB
    await services.patient_service.migrate_json_to_db()
    await services.student_service.migrate_json_to_db()
